...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v4.4.2"
  WORKING_DIRECTORY "/home/ubuntu/ali_vllm/vllm_dflash/vllm/.deps/cutlass-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v4.4.2" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v4.4.2")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v4.4.2")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v4.4.2\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/ali_vllm/vllm_dflash/vllm/.deps/cutlass-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/ali_vllm/vllm_dflash/vllm/.deps/cutlass-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
